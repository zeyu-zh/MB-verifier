...
uint32_t _mm_crc32_u16(uint32_t s, uint16_t v){
    return crc32((char*)&v, 2);
}


uint32_t _mm_crc32_u32(uint32_t s, uint32_t v){
    return crc32((char*)&v, 4);
}

uint32_t _mm_crc32_u64(uint32_t s, uint64_t v){
    return crc32((char*)&v, 8);
}
