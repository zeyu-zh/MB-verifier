...
public:
    ...
    static std::string patternMatching(PMAdaptor * engine, unsigned char * data, uint32_t len, std::vector<int>& node);
	...
	static void updateFlowVeri(veriInfo& flow_veri, std::string & pktVeriResult, Packet* p_in);
