#ifndef CLICK_MIDDLWBOXFL_HH
#define CLICK_MIDDLWBOXFL_HH
...
class MiddleboxFW : public Element {
public:
	MiddleboxFW() CLICK_COLD;

	const char *class_name() const { return "MiddleboxFW"; }
